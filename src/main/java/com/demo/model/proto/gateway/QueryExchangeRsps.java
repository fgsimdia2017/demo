...
/**
 * Protobuf type {@code com.demo.model.proto.gateway.QueryExchangeRsps}
 */
public  final class QueryExchangeRsps extends
    com.google.protobuf.GeneratedMessageV3 implements
    // @@protoc_insertion_point(message_implements:com.demo.model.proto.gateway.QueryExchangeRsps)
    QueryExchangeRspsOrBuilder {
  // Use QueryExchangeRsps.newBuilder() to construct.
  private QueryExchangeRsps(com.google.protobuf.GeneratedMessageV3.Builder<?> builder) {
    super(builder);
  }
  private QueryExchangeRsps() {
    account_ = "";
        ...
        switch (tag) {
          ...
          case 26: {
            if (!((mutable_bitField0_ & 0x00000004) == 0x00000004)) {
              exchanges_ = new java.util.ArrayList<ExchangeInfo>();
              mutable_bitField0_ |= 0x00000004;
            }
            exchanges_.add(
                input.readMessage(ExchangeInfo.parser(), extensionRegistry));
            break;
          }
        }
      }
  ...
  public static final com.google.protobuf.Descriptors.Descriptor
      getDescriptor() {
    return TradeMsgDef.internal_static_com_demo_model_proto_gateway_QueryExchangeRsps_descriptor;
  }

  protected FieldAccessorTable
      internalGetFieldAccessorTable() {
    return TradeMsgDef.internal_static_com_demo_model_proto_gateway_QueryExchangeRsps_fieldAccessorTable
        .ensureFieldAccessorsInitialized(
            QueryExchangeRsps.class, Builder.class);
  }
  ...
  private java.util.List<ExchangeInfo> exchanges_;
  /**
   * <code>repeated .com.demo.model.proto.gateway.ExchangeInfo exchanges = 3;</code>
   */
  public java.util.List<ExchangeInfo> getExchangesList() {
    return exchanges_;
  }
  /**
   * <code>repeated .com.demo.model.proto.gateway.ExchangeInfo exchanges = 3;</code>
   */
  public java.util.List<? extends ExchangeInfoOrBuilder>
   ...
   * <code>repeated .com.demo.model.proto.gateway.ExchangeInfo exchanges = 3;</code>
   */
  public ExchangeInfo getExchanges(int index) {
    return exchanges_.get(index);
  }
  /**
   * <code>repeated .com.demo.model.proto.gateway.ExchangeInfo exchanges = 3;</code>
   */
  public ExchangeInfoOrBuilder getExchangesOrBuilder(
      int index) {
    return exchanges_.get(index);
  }
  ...
  public boolean equals(final Object obj) {
    ...
    if (!(obj instanceof QueryExchangeRsps)) {
      return super.equals(obj);
    }
    QueryExchangeRsps other = (QueryExchangeRsps) obj;
  ...
  public static QueryExchangeRsps parseFrom(
  ...
  public static QueryExchangeRsps parseFrom(byte[] data)
      throws com.google.protobuf.InvalidProtocolBufferException {
    return PARSER.parseFrom(data);
  }
  public static QueryExchangeRsps parseFrom(
  ...
  public static QueryExchangeRsps parseFrom(java.io.InputStream input)
      throws java.io.IOException {
  ...
  public static QueryExchangeRsps parseDelimitedFrom(java.io.InputStream input)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
        .parseDelimitedWithIOException(PARSER, input);
  }
  public static QueryExchangeRsps parseDelimitedFrom(
      java.io.InputStream input,
      com.google.protobuf.ExtensionRegistryLite extensionRegistry)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
  ...
  public static Builder newBuilder(QueryExchangeRsps prototype) {
  ...
  public static final class Builder extends
      ...
      // @@protoc_insertion_point(builder_implements:com.demo.model.proto.gateway.QueryExchangeRsps)
      QueryExchangeRspsOrBuilder {
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return TradeMsgDef.internal_static_com_demo_model_proto_gateway_QueryExchangeRsps_descriptor;
    ...
    // Construct using com.demo.model.proto.gateway.QueryExchangeRsps.newBuilder()
    private Builder() {
    ...
    public QueryExchangeRsps getDefaultInstanceForType() {
      return QueryExchangeRsps.getDefaultInstance();
    }

    public QueryExchangeRsps build() {
      QueryExchangeRsps result = buildPartial();
    ...
    public QueryExchangeRsps buildPartial() {
      QueryExchangeRsps result = new QueryExchangeRsps(this);
    ...
    public Builder mergeFrom(com.google.protobuf.Message other) {
      if (other instanceof QueryExchangeRsps) {
        return mergeFrom((QueryExchangeRsps)other);
      } else {
    ...
    public Builder mergeFrom(QueryExchangeRsps other) {
      if (other == QueryExchangeRsps.getDefaultInstance()) return this;
      if (other.hasRet()) {
    ...
    public Builder mergeFrom(
        ...
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      QueryExchangeRsps parsedMessage = null;
      try {
        parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
      } catch (com.google.protobuf.InvalidProtocolBufferException e) {
        parsedMessage = (QueryExchangeRsps) e.getUnfinishedMessage();
  ...
  checkByteStringIsUtf8(value);
    ...
    private void ensureExchangesIsMutable() {
      if (!((bitField0_ & 0x00000004) == 0x00000004)) {
        exchanges_ = new java.util.ArrayList<ExchangeInfo>(exchanges_);
        bitField0_ |= 0x00000004;
       }
    }

    private com.google.protobuf.RepeatedFieldBuilderV3<
        ExchangeInfo, ExchangeInfo.Builder, ExchangeInfoOrBuilder> exchangesBuilder_;
     ...
     */
    public Builder setExchanges(
        int index, ExchangeInfo.Builder builderForValue) {
      if (exchangesBuilder_ == null) {
        ensureExchangesIsMutable();
     ...
     * <code>repeated .com.demo.model.proto.gateway.ExchangeInfo exchanges = 3;</code>
     */
    public Builder addExchanges(ExchangeInfo value) {
      if (exchangesBuilder_ == null) {
        if (value == null) {
          throw new NullPointerException();
        }
     ...
     */
    public Builder addExchanges(
        ExchangeInfo.Builder builderForValue) {
      if (exchangesBuilder_ == null) {
        ensureExchangesIsMutable();
    ...
    public Builder addAllExchanges(
        Iterable<? extends ExchangeInfo> values) {
      if (exchangesBuilder_ == null) {
        ensureExchangesIsMutable();
     ...
     * <code>repeated .com.demo.model.proto.gateway.ExchangeInfo exchanges = 3;</code>
     */
    public ExchangeInfo.Builder getExchangesBuilder(
        int index) {
     ...
     * <code>repeated .com.demo.model.proto.gateway.ExchangeInfo exchanges = 3;</code>
     */
    public ExchangeInfo.Builder addExchangesBuilder() {
      return getExchangesFieldBuilder().addBuilder(
          ExchangeInfo.getDefaultInstance());
    }
    /**
     * <code>repeated .com.demo.model.proto.gateway.ExchangeInfo exchanges = 3;</code>
     */
    public ExchangeInfo.Builder addExchangesBuilder(
        int index) {
      return getExchangesFieldBuilder().addBuilder(
          index, ExchangeInfo.getDefaultInstance());
    }
    /**
     * <code>repeated .com.demo.model.proto.gateway.ExchangeInfo exchanges = 3;</code>
     */
    public java.util.List<ExchangeInfo.Builder>
         getExchangesBuilderList() {
      return getExchangesFieldBuilder().getBuilderList();
    }
    private com.google.protobuf.RepeatedFieldBuilderV3<
        ExchangeInfo, ExchangeInfo.Builder, ExchangeInfoOrBuilder>
        getExchangesFieldBuilder() {
      if (exchangesBuilder_ == null) {
    ...
    // @@protoc_insertion_point(builder_scope:com.demo.model.proto.gateway.QueryExchangeRsps)
  }

  // @@protoc_insertion_point(class_scope:com.demo.model.proto.gateway.QueryExchangeRsps)
  private static final QueryExchangeRsps DEFAULT_INSTANCE;
  static {
    DEFAULT_INSTANCE = new QueryExchangeRsps();
  }

  public static QueryExchangeRsps getDefaultInstance() {
    return DEFAULT_INSTANCE;
  }

  private static final com.google.protobuf.Parser<QueryExchangeRsps>
      PARSER = new com.google.protobuf.AbstractParser<QueryExchangeRsps>() {
    public QueryExchangeRsps parsePartialFrom(
        com.google.protobuf.CodedInputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws com.google.protobuf.InvalidProtocolBufferException {
        return new QueryExchangeRsps(input, extensionRegistry);
    }
  };

  public static com.google.protobuf.Parser<QueryExchangeRsps> parser() {
    return PARSER;
  }

  @Override
  public com.google.protobuf.Parser<QueryExchangeRsps> getParserForType() {
    return PARSER;
  }
